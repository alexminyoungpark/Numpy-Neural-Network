...
if __name__ == "__main__":
    model = tf.keras.models.load_model("batch_size_10000_gen_num.h5")
    ...
    plt.imsave("batch_size_10000_0.png", img_0, cmap="gray")
    plt.imsave("batch_size_10000_1.png", img_1, cmap="gray")
    plt.imsave("batch_size_10000_2.png", img_2, cmap="gray")
    plt.imsave("batch_size_10000_3.png", img_3, cmap="gray")
    plt.imsave("batch_size_10000_4.png", img_4, cmap="gray")
    plt.imsave("batch_size_10000_5.png", img_5, cmap="gray")
    plt.imsave("batch_size_10000_6.png", img_6, cmap="gray")
    plt.imsave("batch_size_10000_7.png", img_7, cmap="gray")
    plt.imsave("batch_size_10000_8.png", img_8, cmap="gray")
    plt.imsave("batch_size_10000_9.png", img_9, cmap="gray")
